...
internal abstract class ProducerInterceptorPipeline<TContext> where TContext : ProducerContext
{
    ...
    protected ProducerInterceptorPipeline(MessageBusBase bus, object message, ProducerSettings producerSettings, TContext context, IEnumerable<object> producerInterceptors)
    {
        _bus = bus;
