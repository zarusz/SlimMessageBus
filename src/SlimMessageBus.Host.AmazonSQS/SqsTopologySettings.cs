...
/// <returns></returns>
public delegate Task SqsTopologyInterceptor(AmazonSQSClient clientSqs, AmazonSimpleNotificationServiceClient clientSns, Func<Task> provision, CancellationToken cancellationToken);
