...
public class SqsMessageBusSettings
{
    ...
    /// <returns></returns>
    public SqsMessageBusSettings UseAmbientCredentials(SqsMessageBusMode mode = SqsMessageBusMode.All)
    {
    ...
    /// <param name="mode">Should the credentials apply for SQS or SNS service (or both)</param>
    /// <returns></returns>
    public SqsMessageBusSettings UseStaticCredentials(string accessKey, string secretKey, SqsMessageBusMode mode = SqsMessageBusMode.All)
    {
    ...
    /// <param name="mode">Should the credentials apply for SQS or SNS service (or both)</param>
    /// <returns></returns>
    public SqsMessageBusSettings UseRegion(RegionEndpoint region, SqsMessageBusMode mode = SqsMessageBusMode.All)
    {
        if ((mode & SqsMessageBusMode.Sqs) != 0)
        {
    ...
    public SqsMessageBusSettings()
    {
        ...
        UseAmbientCredentials(SqsMessageBusMode.All);
    }
}
