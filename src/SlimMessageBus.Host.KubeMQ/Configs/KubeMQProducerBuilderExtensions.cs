namespace SlimMessageBus.Host.KubeMQ
{
    ...
    public static class KubeMQProducerBuilderExtensions
    {
        /// <summary>
        ...
        public static ProducerBuilder<T> KeyProvider<T>(this ProducerBuilder<T> builder, Func<T, string, byte[]> keyProvider)
        {
            ...
            builder.Settings.Properties[KubeMQProducerSettingsExtensions.KeyProviderKey] = (Func<object, string, byte[]>) UntypedProvider;
            return builder;
        }
        ...
        public static ProducerBuilder<T> PartitionProvider<T>(this ProducerBuilder<T> builder, Func<T, string, int> partitionProvider)
        {
            ...
            builder.Settings.Properties[KubeMQProducerSettingsExtensions.PartitionProviderKey] = (Func<object, string, int>) UntypedProvider;
            return builder;
        }
