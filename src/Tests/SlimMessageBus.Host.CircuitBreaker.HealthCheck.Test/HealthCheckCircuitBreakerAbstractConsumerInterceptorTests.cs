...
public class HealthCheckCircuitBreakerAbstractConsumerInterceptorTests
{
    ...
    public HealthCheckCircuitBreakerAbstractConsumerInterceptorTests()
    {
        accessor = new CircuitBreakerAccessor();

        var h = new HealthCheckCircuitBreakerAbstractConsumerInterceptor();
