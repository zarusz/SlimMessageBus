...
public static class OutboxForwardingPublishInterceptorTests
{
    ...
    public class OnHandleTests
    {
        ...
        public async Task SkipOutboxHeader_IsPresent_PromoteToNext()
        {
            ...
            _mockOutboxRepository.Setup(x => x.Create(It.IsAny<string>(), It.IsAny<IDictionary<string, object>>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<byte[]>(), It.IsAny<CancellationToken>())).Verifiable();
