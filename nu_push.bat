...
nuget push .\%dist_folder%\SlimMessageBus.Host.0.9.13.nupkg -Source %nuget_source%
...
nuget push .\%dist_folder%\SlimMessageBus.Host.Kafka.0.9.13.nupkg -Source %nuget_source%
nuget push .\%dist_folder%\SlimMessageBus.Host.AzureEventHub.0.9.13-alpha1.nupkg -Source %nuget_source%
