...
| `SlimMessageBus.Host.AzureServiceBus`           | Provider for Azure Service Bus                                                                   | [NuGet](https://www.nuget.org/packages/SlimMessageBus.Host.AzureServiceBus)    | 2.0           |
| `SlimMessageBus.Host.AzureEventHub`             | Provider for Azure Event Hubs                                                                    | [NuGet](https://www.nuget.org/packages/SlimMessageBus.Host.AzureEventHub)      | 2.0           |
