...
| `SlimMessageBus.Host.Serialization.NativeJson`   | Serialization plugin for JSON (System.Text.Json library)                                                            | [![NuGet](https://img.shields.io/nuget/v/SlimMessageBus.Host.Serialization.NativeJson.svg)](https://www.nuget.org/packages/SlimMessageBus.Host.Serialization.NativeJson)         |
